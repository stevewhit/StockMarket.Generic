...
BEGIN
	...
	CREATE DATABASE [StockMarketData]
		CONTAINMENT = NONE
		ON  PRIMARY 
	( NAME = N'StockMarketData', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.ITSSQL\MSSQL\DATA\StockMarketData.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
		LOG ON 
	( NAME = N'StockMarketData_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.ITSSQL\MSSQL\DATA\StockMarketData_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
	ALTER DATABASE [StockMarketData] SET COMPATIBILITY_LEVEL = 120
	...
	ALTER DATABASE [StockMarketData] SET TARGET_RECOVERY_TIME = 0 SECONDS 
